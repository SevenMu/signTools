        ...
        try {
            ...
            let res = await axios({
                ...
                header: {
                    ...
                    "cache": "max-age=0",
                    "refer": "https://bbs.kfpromax.com/index.php"
                },
                data: qs.stringify({
                    step: 2,
                    pwuser: user,
            ...
            if (res.status = 200) {
                ...
                res = JSON.stringify(res.headers);
                res = JSON.parse(res);
                cookie = res["set-cookie"];
                cookie.forEach(function(e,index){
                    mid = e.split(";");
                    cookie[index] = mid[0];
                })
                cookie = cookie.join(";");
...
function daily() {
    return new Promise(async (resolve) => {
        try {
            let url = "https://bbs.kfpromax.com/kf_growup.php?ok=3&safeid=12bf2c0";
            let res = await axios({
                method: "post",
                url: url,
                header: {
                    ...
                    "Host": "bbs.kfpromax.com",
                    "cache": "max-age=0",
                    "refer": "https://bbs.kfpromax.com/kf_growup.php",
                    "cookie": cookie
                },
